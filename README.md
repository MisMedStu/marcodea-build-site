...
1. عند مزوّد النطاق، أضف سجلات DNS هذه:
   ...
   | A | `@` | `185.199.110.153` |
   | A | `@` | `185.199.111.153` |
   | CNAME | `www` | `mismedstu.github.io` |

2. في GitHub: **Settings → Pages → Custom domain** ← `marcodeabuild.ly`،
   ثم فعّل **Enforce HTTPS** بعد أن تظهر علامة التحقق.

لا يتغيّر شيء في الكود — الروابط والفهرسة تتبعان النطاق وحدهما.
انتشار سجلات DNS قد يأخذ من دقائق إلى 48 ساعة.
